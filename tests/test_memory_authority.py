...
READERS = {
    ...
    "logos_dashboard/control/measurement.py": "research-OS measurement run: .content of ProviderResult (model answer) -> deterministic scorer -> rate; ModelOutput != Grant; resolves nothing",
}
