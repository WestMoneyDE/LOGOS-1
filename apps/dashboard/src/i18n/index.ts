...
export const NAV: { area: keyof Dict; items: { href: string; key: keyof Dict }[] }[] = [
  ...
  { area: "area_publish", items: [{ href: "/publications", key: "nav_publications" }, { href: "/reports", key: "nav_reports" }, { href: "/evidence-debt", key: "nav_debt" }, { href: "/research", key: "nav_research" }] },
