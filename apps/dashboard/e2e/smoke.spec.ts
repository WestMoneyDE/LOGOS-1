...
const DYNAMIC = new Set(["/", "/system/qa", "/queue", "/runs", "/theses", "/board", "/work-orders", "/decisions", "/system/workers", "/system/quotas", "/system/claude", "/traces", "/benchmarks", "/progress", "/inbox", "/radar", "/notes", "/reports", "/measurements"]);
