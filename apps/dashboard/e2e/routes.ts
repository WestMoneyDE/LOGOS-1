...
export const ROUTES: { path: string; expect: string }[] = [
  ...
  { path: "/inbox", expect: "Eingang" }, { path: "/radar", expect: "Radar" }, { path: "/notes", expect: "Notizbuch" }, { path: "/traces", expect: "Traces" }, { path: "/measurements", expect: "Messlauf" }, { path: "/benchmarks", expect: "Benchmark-Labor" },
