...
```text
core/output_contract.py   closed-schema parse; unknown field = refusal
...
Run it: `python core/output_contract.py`, `python -m pytest tests/test_output_contract.py -q`.
